...
setwd("/Volumes/NGS_Viroscreen/aholtz/euroME/GlobalRabies/github_scripts/")

meta <- read.delim("meta_full_exclusion_clade_simple.tab")
...
nwk <- read.tree("/Volumes/NGS_Viroscreen/aholtz/euroME/GlobalRabies/github_scripts/TempestRooted1327_WGSRate_OutRem.date.nwk")
...
CladeTable <- read_csv("Clade Table - Sheet1.csv")
...
intro <- read.csv("FULLTREE_annotations_table_intro_nonneigh.csv")
